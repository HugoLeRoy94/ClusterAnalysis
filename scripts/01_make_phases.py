...
def parse_args():
    ...
    parser.add_argument("--output-path", type=str, required=True, help="Path to save phase-annotated Parquet file")
...
def main():
    ...
    output_file = Path(args.output_path) / f"phases_{args.input_name}.{args.extension}"
